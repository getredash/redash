...
GOOGLE_DATASOURCE_CLIENT_ID = os.environ.get("REDASH_DATASOURCE_GOOGLE_CLIENT_ID")
GOOGLE_DATASOURCE_CLIENT_SECRET = os.environ.get("REDASH_DATASOURCE_GOOGLE_CLIENT_SECRET")
GOOGLE_DATASOURCE_OAUTH_ENABLED = GOOGLE_DATASOURCE_CLIENT_ID and GOOGLE_DATASOURCE_CLIENT_SECRET
