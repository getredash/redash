...
# Default query visibility: when true, new queries are admin-only; when false, inherit from data source groups
FEATURE_DEFAULT_QUERY_ADMIN_ONLY = parse_boolean(os.environ.get("REDASH_FEATURE_DEFAULT_QUERY_ADMIN_ONLY", "true"))
