...
if SCHEDULED_QUERY_RETRY_INTERVALS:
    SCHEDULED_QUERY_RETRY_INTERVALS = sorted(list(map(lambda x: int(x), SCHEDULED_QUERY_RETRY_INTERVALS)))
...
if ADHOC_QUERY_RETRY_INTERVALS:
    ADHOC_QUERY_RETRY_INTERVALS = sorted(list(map(lambda x: int(x), ADHOC_QUERY_RETRY_INTERVALS)))
