...
function DeprecatedEmbedFeatureAlert() {
    return (<Alert className="m-b-15" type="warning" message={<>
          ...
          <Link href="https://discuss.redash.io/t/support-for-parameters-in-embedded-visualizations/3337" target="_blank" rel="noopener noreferrer">
            Read more
          </Link>
          .
        </>}/>);
...
function EmailNotVerifiedAlert() {
    const verifyEmail = () => {
        axios.post("verification_email/").then(data => {
            notification.success((data as any).message);
        });
    };
    return (<Alert className="m-b-15" type="warning" message={<>
    ...
    return (<div className="home-page">
      <div className="container">
        ...
        <DynamicComponent name="Home.EmptyState">
          ...
          <EmptyState header="Welcome to Redash 👋" description="Connect to any data source, easily visualize and share your data" illustration="dashboard" helpMessage={<EmptyStateHelpMessage helpTriggerType="GETTING_STARTED"/>} showDashboardStep showInviteStep onboardingMode/>
        </DynamicComponent>
...
routes.register("Home", routeWithUserSession({
    path: "/",
    title: "Redash",
