...
function QueryViewCtrl(
  ...
  $scope.canExecuteQuery = () => !$scope.query.$parameters.hasPendingValues() && !$scope.query.$parameters.hasValidationErrors() && ($scope.query.is_safe || (currentUser.hasPermission('execute_query') && !$scope.dataSource.view_only));
