...
function QuerySource(props) {
  ...
  const [autoLimitAvailable, autoLimitEnabled, toggleAutoLimit] = useAutoLimitFlags(dataSource);
  ...
  const doExecuteQuery = useCallback(
    (skipParametersDirtyFlag = false) => {
      query.options.applyAutoLimit = autoLimitAvailable && autoLimitEnabled;
  ...
  }, [isQuerySaving, saveQuery, autoLimitEnabled, autoLimitAvailable, query]);
                ...
                <div className="row editor">
                  <section className="query-editor-wrapper" data-test="QueryEditor">
                    <QueryEditor
                      ...
                      autoLimitEnabled={autoLimitAvailable && autoLimitEnabled}
