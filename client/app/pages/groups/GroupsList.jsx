    ...
    Columns.custom(
      (text, group) => (
        <Button.Group>
          ...
          {currentUser.isAdmin && <Link.Button href={`groups/${group.id}/query_permissions`}>Queries</Link.Button>}
          {currentUser.isAdmin && <Link.Button href={`groups/${group.id}/dashboard_permissions`}>Dashboards</Link.Button>}
        </Button.Group>
      ),
      {
        width: "1%",
