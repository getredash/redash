...
export default class QuerySearchDialog extends React.Component {
  ...
  createSearchQueriesList = () => (this.state.searchedQueries.map(query => (
    <button key={query.id} type="button" className="btn btn-default list-group-item" onClick={() => this.selectQuery(query)}>
