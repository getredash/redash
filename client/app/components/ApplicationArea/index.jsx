  ...
  useEffect(() => {
    function globalErrorHandler(event) {
      ...
      if (event.message === "Uncaught SyntaxError: Unexpected token '<'") {
        ...
        console.error(`[Uncaught SyntaxError: Unexpected token '<'] usually means that a fallback html file was returned from server rather than the expected script. Check that the server is properly serving the file ${event.filename}.`);
      }
