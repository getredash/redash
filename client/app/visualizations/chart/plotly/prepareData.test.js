      ...
      describe("pie", () => {
        test("default", () => {
          const {
            input,
            output
          } = require("./fixtures/prepareData/pie/default");
      ...
      describe("bar (column)", () => {
        test("default", () => {
          const {
            input,
            output
          } = require("./fixtures/prepareData/bar/default");
          const series = cleanSeries(prepareData(input.data, input.options));
          expect(series).toEqual(output.series);
        });
        ...
        test("stacked", () => {
          const {
            input,
            output
          } = require("./fixtures/prepareData/bar/stacked");
          const series = cleanSeries(prepareData(input.data, input.options));
          expect(series).toEqual(output.series);
        });
      ...
      describe("box", () => {
        test("default", () => {
          const {
            input,
            output
          } = require("./fixtures/prepareData/box/default");
          const series = cleanSeries(prepareData(input.data, input.options));
          expect(series).toEqual(output.series);
        });
