...
export default function Editor(props) {
  ...
  return (
    <Tabs animated={false} tabBarGutter={0}>
      <Tabs.TabPane key="general" tab={<span data-test="Gridmap.EditorTabs.General">General</span>}>
        <GeneralSettings {...props} onOptionsChange={optionsChanged} />
      </Tabs.TabPane>
      <Tabs.TabPane key="map-view" tab={<span data-test="Gridmap.EditorTabs.MapView">Map View</span>}>
