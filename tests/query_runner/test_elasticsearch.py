...
class TestElasticsearch(TestCase):
    ...
    def test_get_sub_aggregation_card(self):
        ...
        self.assertEqual(
            [
                {'agg_name': '2018-10-01T00:00:00+0000', 'agg_name.doc_count': 149, 'agg_name.sub_agg.value': 10.99},
                {'agg_name': '2018-10-08T00:00:00+0000', 'agg_name.doc_count': 82, 'agg_name.sub_agg.value': 1.02}
            ],
            rows
        )