...
from redash.authentication.google_oauth import verify_profile as verify_google_profile
from redash.authentication.github_oauth import verify_profile as verify_github_profile
...
class TestVerifyProfile(BaseTestCase):
    ...
    def test_github_domain_not_in_org_domains_list(self):
        profile = dict(email="arik@example.com")
    ...
    def test_google_domain_in_org_domains_list(self):
        profile = dict(email="arik@example.com")
        self.factory.org.settings[models.Organization.SETTING_GOOGLE_APPS_DOMAINS] = [
            "example.com"
        ]
