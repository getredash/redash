...
class TestObjectPermissionsListPost(BaseTestCase):
    def test_creates_permission_if_the_user_is_an_owner(self):
        ...
        rv = self.make_request("post", f"/api/queries/{query.id}/acl", user=query.user, data=data)
    ...
    def test_returns_403_if_the_user_isnt_owner(self):
        ...
        rv = self.make_request("post", f"/api/queries/{query.id}/acl", user=other_user, data=data)
...
class TestObjectPermissionsListDelete(BaseTestCase):
    def test_removes_permission(self):
        ...
        rv = self.make_request("delete", f"/api/queries/{query.id}/acl", user=user, data=data)
    ...
    def test_returns_200_even_if_there_is_no_permission(self):
        ...
        rv = self.make_request("delete", f"/api/queries/{query.id}/acl", user=query.user, data=data)
