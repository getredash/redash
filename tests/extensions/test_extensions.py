...
class TestExtensions(BaseTestCase):
    ...
    def test_working_extension(self):
        self.assertIn("working_extension", list(extensions.extensions.keys()))
        self.assertEqual(
            extensions.extensions.get("working_extension"), "extension loaded"
        )

    def test_assertive_extension(self):
        self.assertNotIn("assertive_extension", list(extensions.extensions.keys()))

    def test_not_findable_extension(self):
        self.assertNotIn("not_findable_extension", list(extensions.extensions.keys()))

    def test_not_importable_extension(self):
        self.assertNotIn("not_importable_extension", list(extensions.extensions.keys()))

    def test_non_callable_extension(self):
        self.assertNotIn("non_callable_extension", list(extensions.extensions.keys()))
    ...
    def test_dummy_periodic_task(self):
        ...
        self.assertIn("dummy_periodic_task", list(extensions.periodic_tasks.keys()))
