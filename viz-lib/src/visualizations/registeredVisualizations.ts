...
export function getDefaultVisualization() {
  ...
  return (
    ...
    Object.values(registeredVisualizations).find(visualization => visualization.isDefault) ||
    ...
    Object.values(registeredVisualizations).find(visualization => !visualization.isDeprecated)
  );
}
